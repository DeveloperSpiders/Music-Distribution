	...
	<div class="screen">
		...
		<%}%>
				<div class="login__field">
					...
					<input type="text" name="firstName" class="login__input" placeholder="Full Name" required="required">
				</div>
				<div class="login__field">
					<i class="login__icon fas fa-envelope"></i>
					<input type="text" name="email" class="login__input" placeholder="Email id" required="required">
				</div>
				<div class="login__field">
					<i class="login__icon fas fa-mobile"></i>
					<input type="text" name="contactNumber" class="login__input" placeholder="Mobile Number" required="required">
				</div>
				<div class="login__field">
			...
			<div class="social-login">
				<h3>Already User? <a href="login">Click here</a></h3>
